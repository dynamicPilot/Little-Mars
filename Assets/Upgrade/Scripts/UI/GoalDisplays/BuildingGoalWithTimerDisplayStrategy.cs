...
{
    public class BuildingGoalWithTimerDisplayStrategy : IGoalDisplayStrategy
    {
        BuildingSlotUISetter _buildingSetter;
        TimerSlotUISetter _timerSetter;
        IGoalInfo _goalInfo;

        public BuildingGoalWithTimerDisplayStrategy(BuildingSlotUISetter buildingSetter,
            TimerSlotUISetter timerSetter,
            IGoalInfo goalInfo)
        {
        ...
        public class Factory : PlaceholderFactory<IGoalInfo, BuildingGoalWithTimerDisplayStrategy>
        {
        }
    }
}
